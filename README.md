**ExportCsvWebApi** เป็นระบบ **Web API** ที่พัฒนาด้วย **C# .NET 8** มีหน้าที่หลักคือ **Export ข้อมูลลูกค้า (Customer Data) เป็นไฟล์ CSV** โดยใช้ **Template CSV** ที่กำหนดไว้ล่วงหน้า 

**คุณสมบัติหลักของระบบ:**
- **ดึงข้อมูลลูกค้า** จาก **In-Memory Database** (จำลองฐานข้อมูล)
- **สร้างไฟล์ CSV ตาม Template** โดยเพิ่มข้อมูล Header และวันที่สร้างรายงาน โดยใช้ ไลบรารี(Library) CsvHelper 
- **รองรับการปรับแต่ง Template** ได้ง่ายผ่านไฟล์ `CustomerTemplate.csv`
- ใช้ **Dependency Injection (DI)** และ **Clean Architecture** เพื่อความยืดหยุ่นในการพัฒนา
#
...
2. **รองรับการตั้งค่าและกำหนดค่าเอง:** เช่น การกำหนด Delimiter (เช่น `,` หรือ `;`)
3. **การจัดการข้อมูลที่ซับซ้อน:** รองรับการ **Mapping Complex Type**, **Custom Type Conversion**
